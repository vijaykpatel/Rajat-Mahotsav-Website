    ...
    <>
      ...
      {!isLoading && (
        <>
          ...
          <ShaderBackground>
            <div className="h-screen w-screen flex flex-col items-center justify-center p-4 relative z-20" style={{ paddingTop: dynamicPadding, height: 'calc(100vh + env(safe-area-inset-bottom))', minHeight: 'calc(100vh + env(safe-area-inset-bottom))' }}>
