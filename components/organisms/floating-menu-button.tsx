  ...
  return (
    <>
      <FloatingButton
        ...
        isVisible={isVisible}
        className="fixed bottom-2 md:bottom-20 left-6 z-40"
        ...
        {isMenuOpen && isVisible && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-16 md:bottom-36 left-6 z-40 rounded-2xl backdrop-blur-md bg-gradient-to-r from-slate-900/20 to-slate-800/20 p-2 shadow-lg w-[220px]"
            >
