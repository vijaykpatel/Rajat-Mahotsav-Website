    ...
    <div ref={containerRef} className="bg-title-section-bg relative">
      ...
      <div ref={invitationRef} className="max-w-[110rem] mx-auto px-6 sm:px-6 md:px-8 lg:px-16 xl:px-20 py-16 md:py-20">
        ...
        >
          ...
          <p>
            The Rajat Mahotsav is not merely an event; it is a tapestry woven from countless prayers, millions of smiles, and twenty-five years of unwavering community spirit. This grand occasion will celebrate the past twenty-five years of faith, community, and fellowship at our temple, with scripture recitals, divine blessings from Acharya Swamiji Maharaj, cultural programs, and special women's events.
          </p>
          <p>
