  ...
  return (
    <section className="relative flex min-h-screen w-full flex-col items-center justify-start pt-28 md:pt-36 gap-16 pb-16 bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
      ...
      <div className="text-center px-4">
        <h2 className="text-5xl md:text-7xl font-bold mb-4 text-white leading-[1.5]">સુવર્ણ યુગ નો રજત મહોત્સવ</h2>
        <p className="text-5xl md:text-7xl font-semibold text-white">A Silver Celebration of a Golden Era</p>
      </div>
